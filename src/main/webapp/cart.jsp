...
<%--                                    </th>--%>
                                ...
                                <c:forEach items=" " var="o">
                                    <tr>
                                        <th scope="row">
                                            <div class="p-2">
                                                <img src="https://cdn.watchstore.vn/uploads/images/dong-ho-orient-ra-ac0f05b10b_1-ims.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                <div class="ml-3 d-inline-block align-middle">
                                                    <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">Orient RA-AC0F05B10B</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                                </div>
                                            </div>
                                        </th>
                                        <td class="align-middle"><strong>199 $</strong></td>
